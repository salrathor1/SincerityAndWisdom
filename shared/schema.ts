...
export const transcripts = pgTable("transcripts", {
  ...
  approvalStatusAr: varchar("approval_status_ar", { length: 20 }).default("unchecked"),
  approvalStatusEn: varchar("approval_status_en", { length: 20 }).default("unchecked"),
  approvalStatusUr: varchar("approval_status_ur", { length: 20 }).default("unchecked"),
  approvalStatusFr: varchar("approval_status_fr", { length: 20 }).default("unchecked"),
  approvalStatusEs: varchar("approval_status_es", { length: 20 }).default("unchecked"),
  approvalStatusTr: varchar("approval_status_tr", { length: 20 }).default("unchecked"),
  approvalStatusMs: varchar("approval_status_ms", { length: 20 }).default("unchecked"),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
